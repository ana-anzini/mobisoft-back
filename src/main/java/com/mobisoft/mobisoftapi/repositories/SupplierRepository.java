...
public interface SupplierRepository extends JpaRepository<Supplier, Long> {
    ...
    @Query("SELECT new com.mobisoft.mobisoftapi.dtos.supplier.SupplierDTO(s.id, s.name, s.cpfOrCnpj, s.phone, s.email, s.cep, s.address, s.number, s.neighborhood, s.additional, c.id, c.description) " +
